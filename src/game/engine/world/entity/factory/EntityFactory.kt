package game.engine.world.entity.factory
...
import game.engine.world.entity.impl.enemies.boss.clown.Hat
import game.engine.world.entity.impl.enemies.boss.ghost.GhostBoss
import game.engine.world.entity.impl.enemies.npcs.*
...
import game.engine.world.pickups.powerups.*
import game.utils.Extensions.getOrTrim

class EntityFactory {
    fun toEntity(entityTypes: EntityTypes, extras: Map<String, String>): Entity? {
