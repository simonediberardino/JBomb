package game.engine.world.domain.entity.actors.impl.enemies.npcs.flying_enemy.properties
...
class FlyingEnemyState(
        ...
        obstacles: Set<Class<out Entity>> = FlyingEnemy.DEFAULT.OBSTACLES,
...
) : EnemyEntityState(entity = entity,
        size = size,
